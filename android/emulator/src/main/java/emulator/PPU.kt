...
class PPU(val cartridge: Cartridge) {
    ...
    private val nespalette = intArrayOf(
        0xFF7C7C7C.toInt(), 0xFFFCFCFC.toInt(), 0xFFF8F8F8.toInt(), 0xFFFCFCFC.toInt(),
        0xFF0000BC.toInt(), 0xFF3C0080.toInt(), 0xFF6C0040.toInt(), 0xFF740000.toInt(),
        0xFF780000.toInt(), 0xFF6C0000.toInt(), 0xFF540000.toInt(), 0xFF3C0000.toInt(),
        0xFF2C0000.toInt(), 0xFF000000.toInt(), 0xFF000000.toInt(), 0xFF000000.toInt(),
        0xFFBCBCBC.toInt(), 0xFF0078F8.toInt(), 0xFF0088F8.toInt(), 0xFF0098F8.toInt(),
        0xFF6C00F8.toInt(), 0xFF9400F8.toInt(), 0xFFB81800.toInt(), 0xFFF80000.toInt(),
        0xFFF80800.toInt(), 0xFFF81800.toInt(), 0xFFF83000.toInt(), 0xFFD84000.toInt(),
        0xFFA85000.toInt(), 0xFF004000.toInt(), 0xFF000000.toInt(), 0xFF000000.toInt(),
        0xFFF8F8F8.toInt(), 0xFF3CBCF8.toInt(), 0xFF6CBCF8.toInt(), 0xFF88BCF8.toInt(),
        0xFFB8B8F8.toInt(), 0xFFD8B8F8.toInt(), 0xFFF8B8D8.toInt(), 0xFFF8A8B8.toInt(),
        0xFFF8A8A8.toInt(), 0xFFF89898.toInt(), 0xFFF87888.toInt(), 0xFFFCA878.toInt(),
        0xFFFCB888.toInt(), 0xFFF8D8B8.toInt(), 0xFFF8F8B8.toInt(), 0xFFF8F8A8.toInt(),
        0xFFFCFCFC.toInt(), 0xFFA8E8FC.toInt(), 0xFFC8D8FC.toInt(), 0xFFD8D0FC.toInt(),
        0xFFE8C8FC.toInt(), 0xFFF8C8F8.toInt(), 0xFFFCC8D8.toInt(), 0xFFFCC8C8.toInt(),
        0xFFFCC8C0.toInt(), 0xFFFCC0B8.toInt(), 0xFFFCB8B0.toInt(), 0xFFFCB8A8.toInt(),
        0xFFFCB8A0.toInt(), 0xFFFCB898.toInt(), 0xFFFCC0A0.toInt(), 0xFFFCD0B0.toInt()
    )
